...
<head>
    ...
    <title>پنل مدیریت | سامانه هوشمند</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-modern sticky-top">
        <div class="container">
            <a class="navbar-brand navbar-brand-modern" href="dashboard.php">
                <i class="bi bi-shield-lock-fill me-2"></i> مدیریت سیستم
            </a>
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link nav-link-modern <?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>" href="dashboard.php">
                            <i class="bi bi-people-fill me-1"></i> مدیریت کاربران
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-modern <?php echo basename($_SERVER['PHP_SELF']) == 'reports.php' ? 'active' : ''; ?>" href="reports.php">
                            <i class="bi bi-bar-chart-line-fill me-1"></i> گزارشات جامع
                        </a>
                    </li>
                </ul>
